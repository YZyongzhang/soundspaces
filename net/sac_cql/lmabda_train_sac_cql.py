...
def train(ckpt_dir):
    ...
    dataloader = DataLoader(dataset=dataset,\
        sampler=sampler ,batch_size=1024)
    
    val_data_base = f'{database_dir}/val_database_combinencode/'
    val_dataloader = DataLoader(dataset=Val_Data(val_data_base) , batch_size=512)
    ...
    for epoch in range(num_epochs):
        ...
        for batch_data in dataloader:
            ...
            if episode % 10000 == 0 and episode != 0:
                torch.save(model.state_dict(), f'{ckpt_dir}/shuffle_muti_env_cql_dn_combinencode_level_0_and_1_2_{episode}.pth')
        ...
        if epoch % 2 == 0:
            ...
            model.train()
            torch.save(model.state_dict(), f'{ckpt_dir}/shuffle_muti_env_cql_dn_combinencode_level_0_and_1_2_{epoch}_{actor_accuracy}.pth')
