...
class Network(nn.Module):
    def __init__(self):
        ...
        self.audiomask = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(512, 1*self.x_dim * self.y_dim),
            nn.Sigmoid()
        )
    ...
    def forward(self, audio, visual_input):
        ...
        audio_mask = audio_mask.view(audio_input.size(0), 1, self.y_dim, self.x_dim)
