...
class AVNet(nn.Module):
    def __init__(self,hid_dim , out_put , width_dim,height_dim):
        ...
        self.model_path = '/data/Getuanhui/checkpoint/avf.pth'
...
class CQL:
    ...
    def compute_loss(self, Q,target_Q , labels):
        ...
        q_regularization = (torch.logsumexp(Q, dim=1) - a_Q).mean()
# ?
...
def train(logging):
    ...
    torch.save(model.state_dict(), './checkpoint/avn3.pth')
    writer.close()
if __name__ == '__main__':
    from torch.utils.tensorboard import SummaryWriter
    log_dir = './logs/loss/avn3'
