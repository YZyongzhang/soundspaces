...
class CQLSAC(nn.Module):
    ...
    def __init__(self, model,
        ...
        self.actor_local = model.policy_net
        self.actor_optimizer = optim.Adam(self.actor_local.parameters(), lr=learning_rate)     
        
        # Critic Network (w/ Target Network)

        self.critic1 = model.Q_net1
        self.critic2 = model.Q_net2
        
        assert self.critic1.parameters() != self.critic2.parameters()
        
        self.critic1_target = model.Q_net1
        self.critic1_target.load_state_dict(self.critic1.state_dict())

        self.critic2_target = model.Q_net2
    ...
    def calc_policy_loss(self, states, alpha):
        _, action_probs, log_pis = self.evaluate(states)
    ...
    def learn(self,  states, next_states , actions, rewards, dones):
        ...
        with torch.no_grad():
            _, action_probs, log_pis = self.evaluate(next_states)
